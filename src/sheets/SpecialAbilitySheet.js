...
export default class SpecialAbilitySheet extends ItemSheet {
  constructor(...args) {
    super(...args)
	...
	static get defaultOptions() {
	  return mergeObject(super.defaultOptions, {
			...
			template: "systems/sw-tor/templates/special-ability-sheet.html",
			width: 554,
			height: 600,
		})
  }
  ...
  getData() {
    ...
    data.specialAbility = data.ability = data.item = this.item
    return data
  }
